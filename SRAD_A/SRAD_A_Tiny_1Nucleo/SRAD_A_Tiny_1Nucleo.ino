...
void Ematches()
{
  ...
  if(altura_real >= 2600  && altura_real < apogeo)
  {
  ...
  if(altura_real <= 304.8 && altura_real < apogeo && drogueState == "1")
  { 
...
{
  reyax.print(paquete);
  delay(100); // 100 ms para la SRAD A y 150 ms para la SRAD B
